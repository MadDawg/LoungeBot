...
const communities = [
    5, 6, indexes['drawr'], indexes['seiga'], indexes['nijie'], indexes['medibang'], indexes['bcyillust'], indexes['bcycosplay']
];

module.exports = { indexes, imageboards, videos, communities}
