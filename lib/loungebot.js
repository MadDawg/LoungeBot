...
const saucenao_indexes = require('./saucenao_indexes.js');
    ...
    constructSauceDispenser(results, indexes){
        ...
        results.forEach((result, i) => {
            ...
            switch(result.header.index_id){
                ...
                // TODO: consider just putting this in some arrays and
                // just checking if element exists
                case 5: case 6:
                case indexes['drawr']: case indexes['seiga']: case indexes['nijie']:
                case indexes['medibang']: case indexes['bcyillust']: case indexes['bcycosplay']:
                ...
                // videos
                case indexes['anime']: case indexes['hanime']:
                case indexes['shows']: case indexes['movies']:
                    embed.addField("Source", result.data.source);
                ...
                // imageboards
                case indexes['konachan']: case indexes['idolcomplex']:
                case indexes['danbooru']: case indexes['gelbooru']:
                case indexes['e621']: case indexes['sankaku']: case indexes['yandere']:
                    embed.addField("Creator", result.data.creator);
