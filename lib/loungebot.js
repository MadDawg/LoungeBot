...
// (i.e. sauce-related functions) to other files
...
class LoungeBot{
    constructor(){
        ...
        guildsDB.sync(); // make sure the database is initialized
    ...
    constructSauceDispenser(results, indexes, minsim, manually_invoked){
        ...
        for (let i = 0; i < embeds.length; i++){
            ...
            console.log(`better_url = "${better_url}"`);
            if (embeds[i].url.startsWith("https://www.pixiv.net/fanbox")) { continue; } // avoid marking fanbox submissions as reuploads
